                                            ...
                                            <tbody>                  
                                                @foreach ($clientes as $clies)
                                                    <tr>
                                                        <td>{{$clies->cli_id}}</td>
                                                        <td>{{$clies->cli_nom}}</td>
                                                        <td><button type="button" class="btn btn-info btn-fab fuse-ripple-ready" data-toggle="modal" data-target="#editarModal"  cli_id="{{$clies->cli_id}}" onclick="setCementerioModal(this)"><i class="icon-lead-pencil" data-toggle="tooltip" data-placement="top" data-original-title="Editar"></i>
                                                        </button>
                                                        <a href="eliminar?cli_id={{$clies->cli_id}}" class="btn btn-danger btn-fab fuse-ripple-ready" data-toggle="tooltip" data-placement="top" data-original-title="Eliminar"><i class="icon-delete"></i></a>

                                                        <!--<a href="/admin/cementerio/pabellones?cli_id={{$clies->cli_id}}" class="btn btn-secondary btn-fab fuse-ripple-ready" data-toggle="tooltip" data-placement="top" data-original-title="Ver pabellones"><i class="icon-eye-outline"></i></a>
                                                        </td>
                                                    -->
                                                    </tr>
                                                @endforeach
